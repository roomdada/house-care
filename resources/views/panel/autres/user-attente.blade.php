              ...
              <table class="table table-hover">
                ...
                @foreach($users as $user)
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-primary"><a href="{{ route('user.attente.active',$user->token) }}" class="text-white">Activer</a></button>
                      <button class="btn btn-danger"><a href="{{ route('delete.user',$user->id) }}" class="text-white">Supprimer</a></button>
                    </td>
