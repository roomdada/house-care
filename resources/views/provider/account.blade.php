								...
								<div class="tab-content">
									<div class="tab-pane fade show active" id="profile_settings" role="tabpanel">
										<form action="{{ route('edit.account.post') }}" method="POST">
											...
											<div class="form-group">
												<label>Moyen de deplacement</label>
												<input name="moving_means" type="text" class="form-control" value="{{auth()->user()->moving_means ? auth()->user()->moving_means : 'Aucun moyen de deplacement' }}" >
											</div>
											<div class="form-group">
												<label>Materiels pour le service</label>
												<input name="materials" type="text" class="form-control" value="{{auth()->user()->materials ? auth()->user()->materials : 'Aucun materiel' }}" >
											</div>
											<div cla
											<div class="form-group">
												<label>Date de naissance</label>
												<input name="birthday" type="text" class="form-control" value="{{auth()->user()->birthday}}" >
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input name="phone_2" type="text" class="form-control" value="{{auth()->user()->phone_2}}" >
											</div>
											<div class="form-group">
												<label>Compagny</label>
												<input name="compagny" type="text" class="form-control" value="{{auth()->user()->compagny}}" >
											</div>
