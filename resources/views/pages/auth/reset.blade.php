            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-8 align-item-center">
                    <div class="border border">
                        <h3 class="bg-gray p-4 text-center">{{$type != 'show' ? 'Nouveau mot de passe' :'Mot de passe oublié'}}</h3>
                         ...
                         <form action="{{ route('confirm.reset') }}" method="POST">
                          @csrf
                          <fieldset class="p-4">
                              <input name='token' type="hidden" value="{{$type}}" placeholder="Veuillez entrer votre email" class="border p-3 w-100 my-2">
