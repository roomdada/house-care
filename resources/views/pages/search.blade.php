                ...
                @if (empty($providers))
                    ...
                    <h3 class="text-center">Proposer une connaissance pour cette prestation</h3>
                       @if (session()->has('message'))
                         ...
                         @endif
                    <form class="form-group" method="POST" action="{{ route('suggestion.path') }}">
                        @csrf
                        ...
                        <input class="form-control" value="{{$service}}" type="hidden" name="prestation"><br>
