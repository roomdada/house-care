                    ...
                    <div class="">
                        <h3 class="bg-gray p-4 text-center">Inscription</h3>
                         ...
                         @if (session()->has('success'))
                           <div style="display: block; width: 100%; border: " class="alert alert-success text-center">
                         {{session()->get('success')}}
                          </div>
                         @endif
                         ...
                         @endif
                            <form action="{{ route('store.register.canvasser') }}" method="POST" enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-row">
                              ...
                              <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                  <label for="inputPassword4">Veuillez entrer un piece d'identité valide(CNI,Attestation,Passport)</label>
